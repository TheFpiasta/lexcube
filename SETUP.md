...
python -c "import xarray as xr; ds = xr.open_zarr('https://data.rsc4earth.de/download/EarthSystemDataCube/v3.0.2/esdc-16d-2.5deg-46x72x144-3.0.2.zarr/'); ds.to_zarr('_data/esdc-16d-2.5deg-46x72x144-3.0.2.zarr', zarr_format=2); print('Done')"
...
(CURRENTLY NOT SUPPORTET) Set `tileCacheDir` to a path where generated tiles will be stored (e.g. `.tiles`). See `config_example.json` for all available dataset options.
